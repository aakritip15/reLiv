...
# Project:  Final.pro
# Template: app
# Command: C:\Qt\6.4.0\mingw_64\bin\qmake.exe -o Makefile Final.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: Final.pro C:/Qt/6.4.0/mingw_64/mkspecs/win32-g++/qmake.conf C:/Qt/6.4.0/mingw_64/mkspecs/features/spec_pre.prf \
		...
		C:/Qt/6.4.0/mingw_64/lib/Qt6Sql.prl \
		...
		Resources.qrc
	$(QMAKE) -o Makefile Final.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
