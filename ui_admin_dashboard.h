...
public:
    ...
    void setupUi(QDialog *admin_dashboard)
    {
        ...
        admin_dashboard->resize(1270, 700);
        admin_dashboard->setStyleSheet(QString::fromUtf8("background-color:#EFE6E7;"));
        label_44 = new QLabel(admin_dashboard);
...
"border-radius:5px;"));
        ...
        line_2 = new QFrame(admin_dashboard);
...
"border-radius:5px;"));
        label_4 = new QLabel(admin_dashboard);
...
"border-radius:5px;"));
        ...
        line_3 = new QFrame(admin_dashboard);
...
"border-image: url(:/img/Images/logo1.png);"));
        ...
        my_details_3 = new QPushButton(admin_dashboard);
...
"border-radius:5px;"));
        line = new QFrame(admin_dashboard);
        line->setObjectName("line");
        line->setGeometry(QRect(20, 210, 89, 3));
        line->setFrameShape(QFrame::HLine);
        line->setFrameShadow(QFrame::Sunken);
        my_details = new QPushButton(admin_dashboard);
...
"	color: rgb(144, 10, 18);\n"
"}"));
        label = new QLabel(admin_dashboard);
        label->setObjectName("label");
        label->setGeometry(QRect(0, 0, 1280, 99));
        label->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);"));
        my_details_2 = new QPushButton(admin_dashboard);
...
"}\n"
""));
        label_11 = new QLabel(admin_dashboard);
...
"border-radius:5px;"));
        label_50 = new QLabel(admin_dashboard);
        label_50->setObjectName("label_50");
        label_50->setGeometry(QRect(470, 500, 51, 51));
        label_50->setStyleSheet(QString::fromUtf8("background-image: url(:/img/Images/Donor.png);"));
        label_36 = new QLabel(admin_dashboard);
...
"border-radius:5px;"));
        ...
        home->setGeometry(QRect(290, 30, 121, 41));
        home->setFont(font2);
...
"color: rgb(144, 10, 18);\n"
"}"));
        why = new QPushButton(admin_dashboard);
...
"color: rgb(144, 10, 18);\n"
"}"));
        label_54 = new QLabel(admin_dashboard);
        label_54->setObjectName("label_54");
        label_54->setGeometry(QRect(800, 500, 141, 51));
        label_54->setFont(font1);
        label_54->setStyleSheet(QString::fromUtf8(""));
        label_5 = new QLabel(admin_dashboard);
...
"border-image: url(:/img/Images/Profile.png);"));
        calendarWidget = new QCalendarWidget(admin_dashboard);
        calendarWidget->setObjectName("calendarWidget");
        calendarWidget->setGeometry(QRect(1010, 450, 231, 219));
...
"border-radius:5px;"));
        ...
        label_51 = new QLabel(admin_dashboard);
...
"color: rgb(144, 10, 18);"));
        pushButton_4 = new QPushButton(admin_dashboard);
        pushButton_4->setObjectName("pushButton_4");
        pushButton_4->setGeometry(QRect(1007, 127, 237, 306));
...
""));
    ...
    {
        admin_dashboard->setWindowTitle(QCoreApplication::translate("admin_dashboard", "Dialog", nullptr));
        label_44->setText(QCoreApplication::translate("admin_dashboard", "O-", nullptr));
        label_13->setText(QString());
        label_43->setText(QString());
        label_45->setText(QString());
        label_42->setText(QCoreApplication::translate("admin_dashboard", "O+", nullptr));
...
"request", nullptr));
        ...
        about->setText(QCoreApplication::translate("admin_dashboard", "About us", nullptr));
        label_3->setText(QString());
        label_52->setText(QCoreApplication::translate("admin_dashboard", "Available\n"
"Donor", nullptr));
        label_48->setText(QCoreApplication::translate("admin_dashboard", "AB-", nullptr));
        label_47->setText(QString());
        label_37->setText(QString());
        label_34->setText(QCoreApplication::translate("admin_dashboard", "A+", nullptr));
        label_12->setText(QString());
        label_19->setText(QCoreApplication::translate("admin_dashboard", "Available units of blood groups ", nullptr));
        label_15->setText(QString());
        label_7->setText(QString());
        label_41->setText(QString());
        my_details_3->setText(QCoreApplication::translate("admin_dashboard", "Blood\n"
"Requests", nullptr));
        label_38->setText(QCoreApplication::translate("admin_dashboard", "B-", nullptr));
        label_17->setText(QString());
        label_16->setText(QString());
        label_2->setText(QString());
        my_details->setText(QCoreApplication::translate("admin_dashboard", "User\n"
"Details", nullptr));
        label->setText(QString());
        my_details_2->setText(QCoreApplication::translate("admin_dashboard", "Donor\n"
"Requests", nullptr));
        ...
        home->setText(QCoreApplication::translate("admin_dashboard", "Home", nullptr));
        why->setText(QCoreApplication::translate("admin_dashboard", "Why become donor", nullptr));
        label_54->setText(QCoreApplication::translate("admin_dashboard", "Campaigns\n"
"Available", nullptr));
