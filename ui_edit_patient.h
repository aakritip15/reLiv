...
"color: rgb(144, 10, 18);}"));
        ...
        about->setGeometry(QRect(420, 30, 130, 41));
        about->setFont(font1);
...
"}"));
        ...
        why->setGeometry(QRect(555, 30, 231, 41));
        why->setFont(font1);
...
"border-color:black;\n"
""));
        login_2 = new QPushButton(edit_patient);
...
"	color: rgb(144, 10, 18);\n"
"}"));
        pushButton_4 = new QPushButton(edit_patient);
...
"Requests", nullptr));
        login->setText(QCoreApplication::translate("edit_patient", "Dashboard", nullptr));
...
"Details", nullptr));
        ...
        login_2->setText(QCoreApplication::translate("edit_patient", "Logout", nullptr));
